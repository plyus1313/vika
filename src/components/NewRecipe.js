		...
		return (
			<form className="new-recipe-form" onSubmit={this.handleSubmit}>
				<div className="new-recipe-header">
					...
					<p className="close-icon" onClick={this.closeNewRecipe}>&#10005;</p>
					{/* <i className="fa fa-times close-form" aria-hidden="true" onClick={this.closeNewRecipe}></i> */}
				</div>
				<hr />
				<div className="new-recipe-body">
					...
					<div className="new-recipe-footer">
						...
						<button className="edit-btn" onClick={this.closeNewRecipe}>Close</button>
					</div>
				</form>
			)
		}
